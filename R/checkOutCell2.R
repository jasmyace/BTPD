...
checkOutCell2 <- function(userID,tblDir="//lar-file-srv/Data/BTPD_2016/Digitizing"){
  out <- tryCatch(
    {
    ...
    error=function(cond){
      message("It appears you broke the function;  however, the lock has been removed.\n")
